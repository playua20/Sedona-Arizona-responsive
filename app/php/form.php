...
//    $photos = $_FILES["ajaxData"];
    ...
    $mail_from = filter_var($_POST["sender_email"], FILTER_SANITIZE_EMAIL);
    ...
    $message = filter_var($_POST["sender_msg"], FILTER_SANITIZE_STRING);
...
//    $item_s . $option_s . 'E-mail: ' . $span_e . $value_s . $mail_from . $semicolon . $span_e . $div_e . $br .
        ...
        $item_s . $option_s . 'Сообщение: ' . $span_e . $value_s . $message . $semicolon . $span_e . $div_e . $br .
