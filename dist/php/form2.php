...
//$headers .= 'Reply-To: ' . $mail_from . "\r\n";
    ...
    // in the e-mail
    $body_message = "This is an example";

//    body_message .= "Name:".$_POST["sender_name"]."Message Posted:".$_POST["modlist"];

    // next, we'll build the invisible portion of the message body
    // note that we insert two dashes in front of the MIME boundary
    // when we use it
    $body_message = "This is a multi-part message in MIME format.\n\n" .
        "--{$mime_boundary}\n" .
