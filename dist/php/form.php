...
//    $item_s . $option_s . 'E-mail: ' . $span_e . $value_s . $mail_from . $semicolon . $span_e . $div_e . $br .
        ...
        $item_s . $option_s . 'Сообщение: ' . $span_e . $value_s . $message . $semicolon . $span_e . $div_e . $div_e . $br .
...
//  $headers = 'From: ' . $mail_from . "\r\n"; // не работает на бесплатном хостинге zzz.com.ua, нужно указывать свой email
    $headers = 'From: ' . $mail_to . "Content-type: text/html; charset=\"utf-8\""; // Content-type: text/html - для отображения html тегов в сообщении
